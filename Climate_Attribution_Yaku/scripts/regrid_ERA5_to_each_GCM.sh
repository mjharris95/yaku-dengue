...
######################################################################################################
## Regrid the ERA5 march monthly temperature data to match each climate model grid in this analysis
...
f_ERA5='../input_data/ERA5/march_monthly_temp_northwest_peru.nc'
f_out=${f_ERA5/.nc/_ACCESS-ESM1-5.nc}
echo $f_out
cdo remapbil,$f_grid $f_ERA5 $f_out
